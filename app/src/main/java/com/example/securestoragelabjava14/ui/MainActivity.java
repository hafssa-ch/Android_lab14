package com.example.securestoragelabjava14.ui;
...
import com.example.securestoragelabjava14.R;
import com.example.securestoragelabjava14.cache.CacheStore;
import com.example.securestoragelabjava14.external.ExternalAppFilesStore;
import com.example.securestoragelabjava14.files.InternalTextStore;
import com.example.securestoragelabjava14.files.StudentsJsonStore;
import com.example.securestoragelabjava14.model.Student;
import com.example.securestoragelabjava14.prefs.AppPrefs;
import com.example.securestoragelabjava14.prefs.SecurePrefs;
...
public class MainActivity extends AppCompatActivity {
    ...
    private SwitchCompat swDark;  // ← modifié ici
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swDark = findViewById(R.id.swDark);   // plus de cast explicite nécessaire
        ...
        try {
            ...
            Log.e(TAG, "Erreur démo externe", e);
        }
    }
    ...
    private void loadPrefsToUi() {
        ...
        try {
            ...
            Log.e(TAG, "Erreur chargement token", e);
        }
    ...
    private void demoExternalStorage() {
        try {
            String path = ExternalAppFilesStore.write(this, "demo_export.txt", "Contenu exporté depuis l'app.");
            if (path != null) {
                Log.d(TAG, "Fichier externe créé : " + path);
                String content = ExternalAppFilesStore.read(this, "demo_export.txt");
                Log.d(TAG, "Contenu relu : " + content);
            } else {
                Log.w(TAG, "Stockage externe non disponible");
            }
        } catch (Exception e) {
            Log.e(TAG, "Erreur démo externe", e);
        }
